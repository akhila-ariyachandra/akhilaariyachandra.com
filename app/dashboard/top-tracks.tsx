...
const TopTracks = asyncComponent(async () => {
  ...
  return (
    <div className="my-10">
      <h2 className="mt-6 font-sora text-2xl font-semibold text-zinc-800 dark:text-zinc-200 sm:text-3xl">
        Top Tracks
      </h2>

      <p className="mb-6 mt-4 font-roboto-slab text-base text-zinc-500 dark:text-zinc-300 sm:text-lg">
          ...
          >
            ...
            <div className="truncate">
              <a
                ...
                className="truncate font-sora text-base font-medium text-emerald-700 dark:text-emerald-600 sm:text-lg"
              >
                {track.name}
              </a>

              <p className="truncate font-roboto-slab text-sm text-zinc-500 dark:text-zinc-300 sm:text-base">
                {track.artist}
              </p>
            </div>
          </div>
