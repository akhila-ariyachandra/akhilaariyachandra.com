...
date: "2019-05-27"
description: "In this series we're going to create a notes app with Node, MongoDB & React. For the first part, let's setup the API."
banner: "/note-app-part-1-setup-the-node-api/banner.png"
---
...
Next let's setup the MongoDB database. If you want a more detailed explanation on setting up the database, you can check out my previous post [Setup MongoDB in Node.js with Mongoose](https://akhilaariyachandra.com/post/setup-mongodb-in-nodejs-with-mongoose/).
