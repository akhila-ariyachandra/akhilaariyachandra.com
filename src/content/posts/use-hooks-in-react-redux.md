...
date: "2019-11-10"
description: "A guide to use Redux Hooks in React"
banner: "/use-hooks-in-react-redux/banner.png"
---

In my [previous post](https://akhilaariyachandra.com/setup-redux-in-a-react-app/) I went through setting up Redux in a React app. Since then I learnt about using hooks as an alternative to the `connect()` Higher Order Component. In this post we will refactor the app we made in the [previous post](https://akhilaariyachandra.com/setup-redux-in-a-react-app/) to use the Redux Hooks.
...
<iframe src="https://codesandbox.io/embed/react-redux-hooks-starter-51wxq?fontsize=14&hidenavigation=1&theme=dark"
     style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
     title="react-redux-hooks-starter"
