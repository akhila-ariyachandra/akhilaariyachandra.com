...
banner: "/getting-started-with-tailwind-css-in-next-js/banner.png"
...
<PostImage
  src="/getting-started-with-tailwind-css-in-next-js/next_app.png"
  width={1860}
  height={909}
...
<PostImage
  src="/getting-started-with-tailwind-css-in-next-js/tailwind_size.png"
  width={855}
  height={130}
...
```javascript:title=tailwind.config.js {2}
module.exports = {
...
<PostImage
  src="/getting-started-with-tailwind-css-in-next-js/title_change.png"
  width={1863}
  height={908}
  title="Title styling"
/>
...
<PostImage
  src="/getting-started-with-tailwind-css-in-next-js/layout_change.png"
  width={1917}
  height={834}
