...
date: "2019-10-13"
description: "Let's see how we can use some of the React life cycle methods in Functional Components"
banner: "/mimic-react-life-cycle-methods-with-hooks/banner.png"
---
...
<SpecialBlock type="warn">
  If you don't set the 2nd argument in a <strong>useEffect</strong> where the
  state is updated, an infinite loop will occur.
</SpecialBlock>
