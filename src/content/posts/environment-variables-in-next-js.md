...
banner: "/environment-variables-in-next-js/banner.png"
updated: "2020-05-17"
---
...
<SpecialBlock type="warn">
  Never commit the <strong>.env</strong> file. Add it to the{" "}
  <strong>.gitignore</strong> file.
</SpecialBlock>
...
<SpecialBlock type="warn">
  Please be careful about which variables you include in the{" "}
  <strong>env</strong> property as they will be included the client JavaScript
  bundle, so make sure you avoid including sensitive data like a database
  connection string or an authentication token secret.
</SpecialBlock>
