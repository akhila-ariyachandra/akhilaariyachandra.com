...
const PostLink = ({ node }) => {
  ...
  return (
    <article className="rounded-md shadow-md transition duration-500 transform hover:text-white hover:antialiased hover:scale-105 hover:shadow-xl hover:bg-green-700 overflow-hidden">
      <header>
        <Img
