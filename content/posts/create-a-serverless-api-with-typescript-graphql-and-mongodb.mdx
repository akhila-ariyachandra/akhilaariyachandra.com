...
<SpecialBlock
  type="info"
  markdown="If you would like to use [Prisma](https://www.prisma.io/) instead of MongoDB, check out my post [here](/serverless-graphql-api-typescript-prisma-postgressql)."
/>
...
```typescript:src/database/models/note.ts
...
```typescript:src/database/models/note.ts {3-7}
import mongoose from "mongoose";
...
```typescript:src/database/models/note.ts {9-13}
import mongoose from "mongoose";
...
```typescript:src/database/models/note.ts {15-16}
import mongoose from "mongoose";
...
```typescript:src/database/models/note.ts {18-19,21}
import mongoose from "mongoose";
...
<SpecialBlock
  type="warn"
  markdown="Next commit the **.env** file. Make sure to add it to **.gitignore**."
/>
...
```typescript:src/database/index.ts {3}
import mongoose from "mongoose";
...
```typescript:src/database/index.ts {5}
import mongoose from "mongoose";
...
```typescript:src/database/index.ts {7-19}
import mongoose from "mongoose";
...
```typescript:api/graphql.ts {7-10,12}
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript:api/graphql.ts {10-14}
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript:api/graphql.ts {15-16}
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript:src/graphql/schema/custom.ts
...
```typescript:src/graphql/schema/note.ts
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/schema/note.ts {3-10}
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/schema/note.ts {4-7}
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/schema/note.ts {9-12}
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/schema/index.ts
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/schema/index.ts {3-4,20}
import { gql } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/custom.ts
...
```typescript:src/graphql/resolvers/note.ts
import mongoose from "mongoose";
...
```typescript:src/graphql/resolvers/note.ts {7}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {7-11}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {10}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {13-25}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {28-44}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {47-87}
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript:pages/api/graphql.ts {5-9}
// ...
