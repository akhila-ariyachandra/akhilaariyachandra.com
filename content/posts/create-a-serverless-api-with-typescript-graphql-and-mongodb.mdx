...
banner: "/posts/create-a-serverless-api-with-typescript-graphql-and-mongodb/banner.png"
---

<SpecialBlock type="info">
  If you would like to use [Prisma](https://www.prisma.io/) instead of MongoDB,
  check out my post
  [here](/serverless-graphql-api-typescript-prisma-postgressql).
</SpecialBlock>
...
```typescript src/database/models/note.ts focus=3:7
import mongoose from "mongoose";
...
```typescript src/database/models/note.ts focus=9:13
import mongoose from "mongoose";
...
```typescript src/database/models/note.ts focus=15:16
import mongoose from "mongoose";
...
```typescript src/database/models/note.ts focus=18:19,21
import mongoose from "mongoose";
...
```typescript src/database/index.ts focus=3
import mongoose from "mongoose";
...
```typescript src/database/index.ts focus=5
import mongoose from "mongoose";
...
```typescript src/database/index.ts focus=7:19
import mongoose from "mongoose";
...
```typescript api/graphql.ts focus=4:5
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript api/graphql.ts focus=7:10,12
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript api/graphql.ts focus=10:14
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript api/graphql.ts focus=15:16
import { ApolloServer } from "apollo-server-micro";
import { getConnection } from "../src/database";
...
```typescript src/graphql/schema/note.ts focus=3:10
import { gql } from "apollo-server-micro";
...
```typescript src/graphql/schema/note.ts focus=4:7
import { gql } from "apollo-server-micro";
...
```typescript src/graphql/schema/note.ts focus=9:12
import { gql } from "apollo-server-micro";
...
```typescript src/graphql/schema/index.ts focus=3:4,20
import { gql } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=7
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=7:11
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=10
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=13:25
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=28:44
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=47:87
import mongoose from "mongoose";
import dayjs from "dayjs";
import NoteModel, { INote } from "../../database/models/note";
import { ApolloError } from "apollo-server-micro";
...
```typescript pages/api/graphql.ts focus=5:9
// ...
