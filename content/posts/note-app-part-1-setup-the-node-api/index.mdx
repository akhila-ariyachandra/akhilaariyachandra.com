...
```json:title=package.json noLineNumbers
{
  "scripts": {
    "dev": "backpack",
...
Next let's setup the MongoDB database. If you want a more detailed explanation on setting up the database, you can check out my previous post [Setup MongoDB in Node.js with Mongoose](/setup-mongodb-in-nodejs-with-mongoose).
...
```javascript:title=src/index.js {22-38}
// Import the dependencies
import express from "express";
import bodyParser from "body-parser";
import cors from "cors";
...
```javascript:title=src/index.js {40-53}
// Import the dependencies
import express from "express";
import bodyParser from "body-parser";
import cors from "cors";
...
```javascript:title=src/index.js {55-71}
// Import the dependencies
import express from "express";
import bodyParser from "body-parser";
import cors from "cors";
...
```javascript:title=src/index.js {73-92}
// Import the dependencies
import express from "express";
import bodyParser from "body-parser";
import cors from "cors";
...
```javascript:title=src/index.js {94-110}
// Import the dependencies
import express from "express";
import bodyParser from "body-parser";
import cors from "cors";
...
All the code from this post is available on [GitHub](https://github.com/akhila-ariyachandra/note-api).
The next part will be about creating a front-end with React to use with this API.
