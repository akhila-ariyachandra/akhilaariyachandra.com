...
Next let's create a layout for out pages. Create the folder `components` in `src` and in it create `Layout.js`. The layout component is also going to contain the navigation links within the app.
...
![Home Page](./result_home.png)

When you navigate to "About" you should see

![About Page](./result_about.png)
