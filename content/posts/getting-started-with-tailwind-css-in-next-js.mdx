...
banner: "/posts/getting-started-with-tailwind-css-in-next-js/banner.png"
unsplash:
...
```javascript tailwind.config.js focus=2:6
module.exports = {
  content: [
...
```jsx pages/index.js focus=6[11:51]
import Layout from "../src/components/Layout";
...
```jsx pages/index.js focus=4[13:41]
const Layout = ({ children }) => {
  return (
    <div>
