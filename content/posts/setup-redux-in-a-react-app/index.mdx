...
```javascript:title=src/redux/user/store.js
const initialState = {
...
```javascript:title=src/redux/index.js {11-17}
import thunk from "redux-thunk";
import logger from "redux-logger";
import { combineReducers, createStore, applyMiddleware } from "redux";
...
```javascript:title=src/redux/index.js {19-25}
import thunk from "redux-thunk";
import logger from "redux-logger";
import { combineReducers, createStore, applyMiddleware } from "redux";
...
```jsx:title=src/components/Display.js {7-9}
import React from "react";
...
```jsx:title=src/components/Display.js {2-3}
import React from "react";
...
```jsx:title=src/components/Display.js {13-15}
import React from "react";
import { bindActionCreators } from "redux";
import { getUser } from "../redux/user/actions";
...
```jsx:title=src/components/Display.js {17}
import React from "react";
import { bindActionCreators } from "redux";
import { getUser } from "../redux/user/actions";
...
```jsx:title=src/components/Display.js {5}
import React from "react";
import { bindActionCreators } from "redux";
import { getUser } from "../redux/user/actions";
...
```jsx:title=src/components/Display.js {6-8}
import React from "react";
import { bindActionCreators } from "redux";
import { getUser } from "../redux/user/actions";
...
```jsx:title=src/components/Display.js {12-36}
import React from "react";
...
<iframe
  src="https://codesandbox.io/embed/react-redux-starter-nn8sy?fontsize=14"
