...
```tsx Comments.tsx focus=2,20:24
import type { FC } from "react";
import { useRef, useEffect } from "react";
...
```tsx Comments.tsx focus=3,7,16:19,30[16:22]
import type { FC } from "react";
import { useRef, useEffect } from "react";
...
```tsx Comments.tsx focus=1,35:37
