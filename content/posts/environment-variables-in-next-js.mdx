...
banner: "/blog/environment-variables-in-next-js/banner.png"
updated: "2020-05-17"
---
...
<SpecialBlock
  type="warn"
  markdown="Never commit the **.env** file. Make sure to add it to **.gitignore**."
/>
...
<SpecialBlock
  type="warn"
  markdown="Please be careful about which variables you include in the **env** property as they will be included the client JavaScript bundle, so make sure you avoid including sensitive data like a database connection string or an authentication token secret."
/>
