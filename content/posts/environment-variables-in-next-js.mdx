...
banner: "/posts/environment-variables-in-next-js/banner.png"
---
...
```javascript next.config.js focus=3:7
const Dotenv = require("dotenv-webpack");
...
```javascript next.config.js focus=5:6
const Dotenv = require("dotenv-webpack");
...
```javascript next.config.js focus=6
const Dotenv = require("dotenv-webpack");
...
```javascript next.config.js focus=10:14
const Dotenv = require("dotenv-webpack");
