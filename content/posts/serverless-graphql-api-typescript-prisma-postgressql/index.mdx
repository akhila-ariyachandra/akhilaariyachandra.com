...
banner: "/blog/serverless-graphql-api-typescript-prisma-postgressql/banner.jpg"
coverImage: "./banner.jpg"
photographer: "Anas Alshanti"
unsplashLink: "https://unsplash.com/s/photos/coding?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText"
---
...
<SpecialBlock
  type="warn"
  markdown="Remember to not commit the **.env** file. Add it to **.gitignore**."
/>
...
<SpecialBlock
  type="info"
  markdown="Replace **init** with the name of your migration."
/>
...
```typescript:api/graphql.ts {6-9,11}
import { ApolloServer } from "apollo-server-micro";
...
```typescript:api/graphql.ts {9,10}
import { ApolloServer } from "apollo-server-micro";
...
```typescript:src/graphql/resolvers/note.ts {9-17}
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
...
```typescript:src/graphql/resolvers/note.ts {20-37}
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
...
```typescript:src/graphql/resolvers/note.ts {40-79}
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
