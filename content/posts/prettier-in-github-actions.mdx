...
Then add a script to your `package.json` file that makes formatting all you files in one go easier.
...
<PostImage
  ...
  alt="The branch protection rules"
  width={1110}
  height={1043}
/>
...
<PostImage
  ...
  alt="A successful check in the pull request"
  width={914}
  height={310}
/>
