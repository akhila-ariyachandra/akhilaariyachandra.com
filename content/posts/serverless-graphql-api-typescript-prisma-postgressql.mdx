...
banner: "/posts/serverless-graphql-api-typescript-prisma-postgressql/banner.jpg"
unsplash:
  photographer: Anas Alshanti
  link: https://unsplash.com/s/photos/coding?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText
---
...
```prisma src\db\schema.prisma focus=13:18
// This is your Prisma schema file,
// learn more about it in the docs: https://pris.ly/d/prisma-schema
...
```typescript api/graphql.ts focus=3:4
import { ApolloServer } from "apollo-server-micro";
...
```typescript api/graphql.ts focus=6:9,11
import { ApolloServer } from "apollo-server-micro";
...
```typescript api/graphql.ts focus=9,10
import { ApolloServer } from "apollo-server-micro";
...
```typescript src/graphql/resolvers/note.ts focus=9:17
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
...
```typescript src/graphql/resolvers/note.ts focus=20:37
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
...
```typescript src/graphql/resolvers/note.ts focus=40:79
import { ApolloError } from "apollo-server-micro";
import { PrismaClient, Note } from "@prisma/client";
