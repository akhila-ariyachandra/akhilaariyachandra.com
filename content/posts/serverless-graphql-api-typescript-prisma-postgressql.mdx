...
unsplash_link: "https://unsplash.com/s/photos/coding?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText"
---
...
If you need a database without installing one locally, [Heroku](https://www.heroku.com/postgres) has free tier.
...
<SpecialBlock type="warn">
  Remember to not commit the <strong>.env</strong> file. Add it to{" "}
...
<SpecialBlock type="info">
  Replace <strong>init</strong> with the name of your migration.
</SpecialBlock>
...
I made a sample deployment which you can check out [here](https://serverless-api-graphql-prisma.vercel.app/api/graphql). The source code is available on [GitHub](https://github.com/akhila-ariyachandra/serverless-api-graphql-prisma).
