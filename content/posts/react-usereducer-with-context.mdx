---
title: Using useReducer with context
date: "2021-06-19"
description: "Sharing state in multiple components with useReducer and context"
banner: "/blog/react-usereducer-with-context/banner.png"
---

`useReducer` is a hook we can use to manage an advanced state and **Context** is used to share state between components.
...
This post will not be an introduction to `useReducer` and **Context**, so I'll include links to both of them if you want to learn about them first.
...
<CodeSandboxWrapper codeSandboxId="react-usereducer-with-context-8ld7z" />
