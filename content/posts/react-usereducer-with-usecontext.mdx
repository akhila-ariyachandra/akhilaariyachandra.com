...
posted: "2021-06-19"
description: "Sharing state in multiple components with useReducer and useContext"
banner: "/posts/react-usereducer-with-usecontext/banner.png"
---
...
```jsx src\context\ValueContext.jsx
import React from "react";
```

Then define the initial state.

```jsx src\context\ValueContext.jsx focus=3:5
import React from "react";
...
```jsx src\context\ValueContext.jsx focus=7:22
import React from "react";
...
```jsx src\context\ValueContext.jsx focus=1,24:27
...
```jsx src\context\ValueContext.jsx focus=1,29:37
...
```jsx src\context\App.js focus=1,6:9
...
```jsx src\components\Input.jsx focus=2,5:8
import React from "react";
...
```jsx src\components\Input.jsx focus=10:12,16
import React from "react";
import { ValueContext } from "../context/ValueContext";
...
```jsx src\components\Input.jsx focus=14:16,21
...
```jsx src\context\App.js focus=1,9
...
```jsx src\components\Display.jsx
import React, { useContext } from "react";
import { ValueContext } from "../context/ValueContext";
