...
```jsx:src\context\ValueContext.jsx {3-5}
import React from 'react';
...
```jsx:src\context\ValueContext.jsx {7-22}
import React from 'react';
...
```jsx:src\context\ValueContext.jsx {1,24-27}
...
```jsx:src\context\ValueContext.jsx {1,29-37}
...
```jsx:src\components\Input.jsx {2,5-8}
import React from 'react';
...
```jsx:src\components\Input.jsx {10-12,16}
import React from 'react';
import { ValueContext } from "../context/ValueContext";
...
```jsx:src\components\Input.jsx {14-16,21}
