...
banner: "/blog/persistent-state-in-react/banner.png"
---
...
<SpecialBlock
  type="warn"
  markdown={`This guide will not work as is in frameworks like [Next.js](https://nextjs.org/ "Next.js") or [Gatsby](http://gatsbyjs.org/ "Gatsby") because the components aren't first rendered in the browser and **localstorage** can't be accessed. If you want to learn more about how rendering differs in the browser and the server check out this [awesome post](https://joshwcomeau.com/react/the-perils-of-rehydration/ "The Perils of Rehydration").`}
/>
