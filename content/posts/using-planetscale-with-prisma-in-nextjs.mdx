...
date: "2022-07-29"
description: "Quickly setup PlanetScale with Prisma in a Next.js project"
banner: "/blog/using-planetscale-with-prisma-in-nextjs/banner.png"
---
...
Another change we need to make is to how foreign keys are handled in our database. PlanetScale does not support foreign keys so we need to make Prisma handle them manually using the [Referential integrity](https://www.prisma.io/docs/concepts/components/prisma-schema/relations/referential-integrity) feture.
...
<PostImage
  src="/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-1.png"
  width={1320}
  height={734}
...
<PostImage
  src="/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-2.png"
  width={1325}
  height={934}
...
<PostImage
  src="/blog/using-planetscale-with-prisma-in-nextjs/deploy-request-3.png"
  width={1335}
  height={796}
...
<PostImage
  src="/blog/using-planetscale-with-prisma-in-nextjs/deploy-vercel-1.png"
  width={1329}
  height={657}
...
<PostImage
  src="/blog/using-planetscale-with-prisma-in-nextjs/deploy-vercel-2.png"
  width={1310}
  height={725}
  title="Database URL"
/>
