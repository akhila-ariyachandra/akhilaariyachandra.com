...
In the 2nd part of this series we're going to create a site with React to use with our Node API to create and view Notes. In the previous [post](/note-app-part-1-setup-the-node-api "Note App - Part 1: Setup the Node API") we created the API for the app.

## Prerequisites

- The Node API from the previous [post](/note-app-part-1-setup-the-node-api "Note App - Part 1: Setup the Node API") must be up and running
- Setup the project following my [guide](/getting-started-in-react-with-parcel-js "Getting started in React with Parcel.js")
- A basic understanding of [React hooks](https://reactjs.org/docs/hooks-intro.html)

## Setup

First we need to setup the React project with a bundler. The bundler we're going to be using is [Parcel](https://parceljs.org/), as it requires very little setup. Follow my [guide](/getting-started-in-react-with-parcel-js "Getting started in React with Parcel.js") to get started.
...
```html:title=src/index.html {10-15}
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
![First Preview](./result_1.png)

After you create the note, it should look like this

![Second Preview](./result_2.png)
