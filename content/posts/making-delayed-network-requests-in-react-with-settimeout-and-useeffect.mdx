...
banner: "/posts/making-delayed-network-requests-in-react-with-settimeout-and-useeffect/banner.png"
unsplash:
  photographer: Erik Mclean
  link: https://unsplash.com/@introspectivedsgn?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
---
...
<SpecialBlock type="info">
  This blog no longer has reactions but the code above is still valid and can be
  used.
</SpecialBlock>
