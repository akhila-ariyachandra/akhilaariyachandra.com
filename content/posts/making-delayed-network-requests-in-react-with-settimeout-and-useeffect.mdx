...
date: "2021-09-13"
description: "Using setTimeout and useEffect to delay network requests after state changes"
banner: "/blog/making-delayed-network-requests-in-react-with-settimeout-and-useeffect/banner.png"
photographer: "Erik Mclean"
unsplash_link: "https://unsplash.com/@introspectivedsgn?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText"
---
...
<Video name="reactions" width={610} height={128} title="Reactions Example" />

<SpecialBlock type="info">You can try it yourself. 👇🏽</SpecialBlock>

<Reactions showDescription={false} />
...
Saving on every click would be the easiest but it would create problems such as race conditions, issues with the optimistic UI updates I'm handling with [React Query](https://react-query.tanstack.com/) and rate limits with any hosting provider. So my best option was the second one.
...
<Video name="network" width={1536} height={534} title="Network Tab Example" />

You can see the code in action just below. 😊
