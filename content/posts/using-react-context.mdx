...
banner: "/blog/using-react-context/banner.png"
---
...
<SpecialBlock
  type="info"
  markdown={`If you want to learn how to setup Redux in a React App, check out my [post here](https://akhilaariyachandra.com/setup-redux-in-a-react-app/ "Setup Redux in a React app"). If you want to use Redux with hooks check out my [post here](https://akhilaariyachandra.com/use-hooks-in-react-redux/ "Use Hooks in React Redux").`}
/>
...
<PostImage
  src="/blog/using-react-context/app.png"
  width={279}
  height={150}
...
```jsx:src/context/UserContext.js {10-12}
import React from "react";
...
```jsx:src/context/UserContext.js {11-13, 16}
import React from "react";
...
```jsx:src/context/UserContext.js {15-30,32-34}
import React from "react";
...
```jsx:src/components/Display.js {2,5}
import React from "react";
...
```jsx:src/components/Display.js {9-31}
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx:src/components/Controls.js {2,5}
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx:src/components/Controls.js {9,11}
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx:src/components/Controls.js {11,18}
import React from "react";
import { UserContext } from "../context/UserContext";
