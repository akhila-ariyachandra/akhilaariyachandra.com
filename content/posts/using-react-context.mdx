...
banner: "/posts/using-react-context/banner.png"
---
...
<SpecialBlock type="info">
  ...
  here](https://akhilaariyachandra.com/setup-redux-in-a-react-app/ "Setup Redux
  in a React app"). If you want to use Redux with hooks check out my [post
  here](https://akhilaariyachandra.com/use-hooks-in-react-redux/ "Use Hooks in
  React Redux").
</SpecialBlock>
...
```jsx src/context/UserContext.js focus=3:8
import React from "react";
...
```jsx src/context/UserContext.js focus=10:12
import React from "react";
...
```jsx src/context/UserContext.js focus=11:13,16
import React from "react";
...
```jsx src/context/UserContext.js focus=15:30,32:34
import React from "react";
...
```jsx src/components/Display.js focus=2,5
import React from "react";
...
```jsx src/components/Display.js focus=9:31
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx src/components/Controls.js focus=2,5
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx src/components/Controls.js focus=9,11
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx src/components/Controls.js focus=11,18
import React from "react";
import { UserContext } from "../context/UserContext";
...
```jsx src/App.js focus=2:3,10,12
import React from "react";
