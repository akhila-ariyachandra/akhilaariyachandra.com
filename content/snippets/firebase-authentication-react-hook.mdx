...
<SpecialBlock
  type="info"
  markdown="Please note I'm using the [modular version](https://firebase.google.com/docs/web/learn-more#modular-version) of Firebase. Switch to the relevant imports for versions 8 and below."
/>
