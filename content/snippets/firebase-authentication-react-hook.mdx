...
<SpecialBlock type="info">
  Please note I'm using the{" "}
  <a
    href="https://firebase.google.com/docs/web/learn-more#modular-version"
    target="_blank"
    rel="noopener noreferrer"
  >
    modular version
  </a>{" "}
  of Firebase. Switch to the relevant imports for versions 8 and below.
</SpecialBlock>
