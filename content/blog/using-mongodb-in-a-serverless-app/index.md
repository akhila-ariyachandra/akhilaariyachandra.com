...
If you have been developing an API in Node setting up a connection to a MongoDB database is relatively straight forward. Check out my [previous post](https://akhilaariyachandra.com/setup-mongodb-in-nodejs-with-mongoose) if you need a refresher.
