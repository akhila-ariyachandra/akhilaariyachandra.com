...
Finally to make the variables available in the runtime code, we need to add one more property to the Next.js config. Add a new property called `env` and list all the environment variables you want in the runtime code as follow.
