...
| `NEXT_PUBLIC_POSTHOG_KEY`  | [PostHog](https://posthog.com/) project API key                                                                                                                                                                                                                                                             |
| `NEXT_PUBLIC_POSTHOG_HOST` | The host URL for [PostHog](https://posthog.com/) through [Next.js rewrites](https://posthog.com/docs/advanced/proxy/nextjs)                                                                                                                                                                                 |
