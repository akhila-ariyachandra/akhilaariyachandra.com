...
| `NEXT_PUBLIC_SANITY_PROJECT_ID` | [Sanity](https://www.sanity.io/) project ID used by the web app image + content client                                                                                                       |
|   `NEXT_PUBLIC_SANITY_DATASET`   | [Sanity](https://www.sanity.io/) dataset used by the web app image + content client                                                                                                          |
| `NEXT_PUBLIC_SANITY_API_VERSION` | [Sanity](https://www.sanity.io/) API version for content reads (optional, defaults to `2026-03-01`)                                                                                         |
